...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "profile_prompt_wbs_date": "Enter your WBS valid-until date in DD.MM.YYYY format:",
        ...
        "profile_invalid_date": "⚠️ Use the DD.MM.YYYY format.",
    ...
    "ru": {
        ...
        "profile_prompt_wbs_date": "Введите дату действия WBS в формате DD.MM.YYYY:",
        ...
        "profile_invalid_date": "⚠️ Используйте формат DD.MM.YYYY.",
